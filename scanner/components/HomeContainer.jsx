      ...
      >
        <View style={styles.cardRow}>
          <View style={styles.creditContainer}>
            ...
            <Text style={styles.h2}>{new Date().toLocaleDateString()}</Text>
          </View>
          ...
          <View style={styles.flexRowBetween}>
            ...
            >
              <View style={{ flexDirection: "row" }}>
                ...
                />
                <Text style={styles.tripTxt}>New Trip</Text>
              </View>
            </TouchableOpacity>
            {/* <ThemeButton
              title={"New Trip"}
        ...
        <View style={styles.card}>
          <View style={styles.flexRowBetween}>
            ...
            >
              <Entypo name="list" size={24} color={theme.colors.primaryIcon} />
            </ThemeButton>
          </View>
          <View style={styles.hr} />
          <View style={styles.center}>
            {refreshing ? (
              <Text style={styles.text}>Loading recent trips...</Text>
            ) : recent?.length > 0 ? (
              recent.map((item) => (
                <View key={item._id} style={styles.itemContainer}>
                  <TripCard trip={item} onPress={() => handleItemClick(item)} />
                </View>
              ))
            ) : (
