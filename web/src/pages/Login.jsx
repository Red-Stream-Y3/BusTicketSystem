...
const Login = () => {
    ...
    return (
        <div className="h-screen overflow-hidden flex items-center justify-center bg-lightbg" data-testid="login">
            ...
            <div className="min-w-screen min-h-screen  flex items-center justify-center px-5 py-5 bg-main-dark-bg">
                <div className=" text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden">
                    <div className="md:flex w-full">
                        ...
                        <div className="w-full md:w-1/2 py-5 px-5 md:pl-10 bg-white">
                            <div className="text-center my-5 flex items-center">
                                <BsBusFront className="h-8 w-8 text-darkbg" />
                                <span className="text-black font-extrabold ml-2 text-3xl">Bus Ticket System</span>
                            </div>

                            <div className="text-center mb-10">
                                <h1 className="font-bold text-3xl text-gray-900 mb-2">USER LOGIN</h1>
                                ...
                                <div>
                                    <div className="flex -mx-3">
                                        <div className="w-full px-3 mb-5">
                                            <label htmlFor="Email" className="text-s font-semibold px-1">
                                                Email
                                            </label>
                                            <div className="flex">
                                    ...
                                    <div className="flex -mx-3">
                                        <div className="w-full px-3 mb-5">
                                            <label htmlFor="Password" className="text-s font-semibold px-1">
                                                Password
                                            </label>
                                            <div className="flex">
                                                <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
