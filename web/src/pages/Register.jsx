...
const Register = () => {
    ...
    const submitHandler = async (e) => {
        ...
        if (password !== confirmPassword) {
            ...
            if (email && password) {
                const { data } = await register(username, firstName, lastName, email, password, phone, role);
                if (data) {
                    setUser(data);
                }
            }
                        ...
                        <div className="md:flex w-full">
                            ...
                            <div className="w-full md:w-1/2 py-10 px-5 md:px-10 bg-gray-100">
                                <div className="text-center mb-5">
                                    <h1 className="font-bold text-3xl text-gray-900">USER REGISTRATION</h1>
                                    ...
                                    <div>
                                        ...
                                        <div className="flex -mx-3">
                                            <div className="w-full px-3">
                                                <button className="block w-full max-w-xs mx-auto  bg-secondary hover:bg-primarylight hover:text-darkbg  text-white rounded-lg px-3 py-2 font-semibold">
                                                    REGISTER
                                                </button>
                                            </div>
                                        </div>
